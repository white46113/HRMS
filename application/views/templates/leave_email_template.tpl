                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    "
                                                >
                                                    <img alt="" src="{{$base_url}}public/assets/images/logos/dark-logo.svg" width="300" style="height: auto; display: block;" />
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                            	<td style="padding: 0 0 36px; color: rgba(21, 54, 67, 1);">
                                                            		...
                                                            		{{if $email_type == "aprove_reject_leave"}}
                                                            		<p style="margin: 0 0 12px; font-size: 16px; line-height: 24px; font-family: Arial, sans-serif;">
                                                                        I hope this message finds you well. I wanted to inform you about the status of your leave request that you submitted for {{$from_date}} to {{$to_date}}. After careful consideration, I am pleased to inform you that your leave has been {{$status}}.
                                                                    </p>

                                                                    {{else if $email_type == "request_leave"}}

                                                                    <p style="margin: 0 0 12px; font-size: 16px; line-height: 24px; font-family: Arial, sans-serif;">
																	    Thank you for submitting your leave application. We have received your request for leave from {{$from_date}} to {{$to_date}} for {{$leave_type}}.
																	</p>
																	<p style="margin: 0 0 12px; font-size: 16px; line-height: 24px; font-family: Arial, sans-serif;">
                                                                    ...
                                                                    {{else if $email_type == "update_leave"}}
                                                                    <p style="margin: 0 0 12px; font-size: 16px; line-height: 24px; font-family: Arial, sans-serif;">
                                                                    ...
                                                                    <p style="margin: 0 0 12px; font-size: 16px; line-height: 24px; font-family: Arial, sans-serif;">
                                                                        Updated Leave Dates: {{$from_date}} to {{$to_date}}<br />
