                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding: 0 0 36px; color: rgba(21, 54, 67, 1);">
                                                                    ...
                                                                    <p>
                                                                        <span style="font-size: 16px;"><strong>OTP:</strong>&nbsp;&nbsp;<span style="color: #000000; font-size: 18px; letter-spacing: 5px; font-weight: 600;">{{$otp}}</span></span>
                                                                    </p>
                                                                    <p>
