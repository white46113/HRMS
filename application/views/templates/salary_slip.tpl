                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <tbody>
                                                    {foreach $income_arr as $key => $val}
                                                        ...
                                                        <tr style="line-height: 1; padding: 0; margin: 0;">
                                                            <td width="40%" valign="middle" align="left" style="padding: 0; margin: 0;">
                                                                <font style="font-size: 12px;" face="Arial, Helvetica, sans-serif" color="#222222">
                                                                    {$val.component_name}
                                                                </font>
                                                            </td>

                                                            <td width="30%" valign="middle" align="right" style="padding: 0; margin: 0;">
                                                                <font style="font-size: 12px;" face="Arial, Helvetica, sans-serif" color="#222222">
                                                ...
                                                {/foreach}
                                                    <tr style="line-height: 1; padding: 0; margin: 0;">
                                                    <td width="40%" height="30" valign="middle" align="left" style="padding: 0; margin: 0;">
                                                        <font style="font-size: 12px;" face="Arial, Helvetica, sans-serif" color="#222222">
                                                            <strong>Gross Earning</strong>
                                                        </font>
                                                    </td>

                                                    <td width="30%" height="30" valign="middle" align="right" style="padding: 0; margin: 0;">
                                                        <font style="font-size: 12px;" face="Arial, Helvetica, sans-serif" color="#222222">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    {foreach $deduction_arr as $key => $val}
                                                                         <tr style="padding: 0; margin: 0; line-height: 1;">
                                                                            <td width="40%"  valign="middle" align="left" style="padding: 0; margin: 0;">
                                                                                <font style="font-size: 12px; padding: 0; margin: 0;" face="Arial, Helvetica, sans-serif" color="#222222">
                                                                                    {$val.component_name}
                                                                                </font>
                                                                            </td>
                                 ...
                                 <table cellspacing="0" cellpadding="5" border="0" width="100%" align="center" >
                                   <tbody>
                                    <tr>
                                        ...
                                        <br><br>
                                            <font style="font-size: 14px;" face="Arial, Helvetica, sans-serif" color="#222222">
